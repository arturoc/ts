 ...
 */
export async function downloadScene(baseUrl: URL, configPath: string, abortSignal?: AbortSignal, useWasmParser = false): Promise<RenderStateScene> {
    ...
    return { url: baseUrl.toString(), config, useWasmParser } as const;
}
